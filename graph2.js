    ...
    $.fn.drawDoughnutChart = function(data, options) {
        var $this = this,
            ...
            settings = $.extend({
                ...
                segmentStrokeColor : "rgba(255,255,255,.8)",
                segmentStrokeWidth : 2,
                baseColor: "rgba(255,255,255,.85)",
                baseOffset: 2,
        ...
        var $svg = $('<svg width="' + W + '" height="' + H + '" viewBox="0 0 ' + W + ' ' + H + '" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"></svg>').appendTo($this),
            ...
            cutoutRadius = doughnutRadius * (settings.percentageInnerCutout/82),
            segmentTotal = 0;
        ...
        //Set up tooltip
        var $tip = $('<div class="' + settings.tipClassName + '" />').appendTo('body').hide(),
            tipW = $tip.width(),
            tipH = $tip.height();
